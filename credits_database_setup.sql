-- Credits system database setup for INFINITO
...
-- Create function to add credits to a user
...
-- Update the add_user_credits function to log transactions
CREATE OR REPLACE FUNCTION public.add_user_credits(
  user_id UUID,
  credits_to_add INTEGER,
...
-- Update the deduct_user_credits function to log transactions
CREATE OR REPLACE FUNCTION public.deduct_user_credits(
  user_id UUID,
  credits_to_deduct INTEGER,
